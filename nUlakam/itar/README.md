...
| `mUZRuppuLLi.qmz` | three-point estimation — `முப்புள்ளி_ஆக்கு` `பீட்டா_சராசரி` `முக்கோண_சராசரி` `நியம_விலகல்` `பரவல்` `பாதை_சராசரி` `பாதை_பரவல்` `பாதை_விலகல்` `தவறாக_விலகல்களைக்_கூட்டினால்` `_நிகழ்தகவு_Z` `_நம்பிக்கைக்கான_Z` `இலக்கு_நிகழ்தகவு` `நம்பிக்கை_காலம்` |
