...
// rustfmt is off for this table on purpose.
//
// One line per token, attribute and variant together, is how 200-odd tokens stay
// readable, and it is load-bearing: scripts/generate_editor_support.py and
// scripts/generate_keywords.py both read this table a line at a time. rustfmt
// splits each entry across two lines, which doubles the table and makes both
// scripts find no keywords at all.
#[rustfmt::skip]
#[logos(skip(r"//[^\n]*", allow_greedy = true))]
pub enum Token {
    ...
    #[regex("சொத்து|coqqu|soqqu")] Asset,
    #[regex("பொறுப்பு|poRuppu")] Liability,
    #[regex("பங்கு|pawku")] Equity,
    #[regex("வருவாய்|varuvAy")] Revenue,
    #[regex("செலவு|celavu")] Expense,
    #[regex("வருமானம்|varumAZam")] Income,
    #[regex("பயன்|payaZ")] Profit,
    ...
    #[regex("கடன்தீர்ப்பு|kataZqIrppu|kataZ_qIrppu")] Amortization,
    #[regex("மதிப்புயர்வு|maqippuyarvu|matippuyarvu")] Appreciation,
    #[regex("மூலதனம்|mUlaqaZam|mUlataZam")] Capital,
    #[regex("இருப்பாய்வு|iruppAyvu")] TrialBalance,
    #[regex("இருப்புநிலை|iruppunilY")] BalanceSheet,
    #[regex("வருமான_அறிக்கை|varumAZa_aRikkY|varumAZ_aRikkY")] IncomeStatement,
    #[regex("பணப்புழக்கம்|paNappuzakkam")] CashFlow,
    #[regex("வருமான_வரி|varumAZa_vari|varumAZ_vari")] IncomeTax,
    ...
    #[regex("எண்|eN|_int")] IntegerType,
    #[regex("பின்னம்|piZZam|_float")] FloatType,
    #[regex("சொல்|col|_string")] StringType,
    #[regex("ஈர்ம|Irma|_bool")] BoolType,
    #[regex("உரை|urY|_text")] TextType,
    #[regex("அணி|aNi|_array")] ArrayType,
    #[regex("தரவு|qaravu|_data")] DataType,
    #[regex("பொருள்|poruL|_object")] ObjectType,
    #[regex("தேதி|qEqi|_date")] DateType,
    #[regex("மெய்|mey|_true")] True,
    ...
    #[regex("இன்றேல்|iZREl|_else")] Else,
    #[regex("சுற்று|cuRRu|_loop")] Loop,
    #[regex("அச்சு|accu|_print")] Print,
    #[regex("உள்ளிடு|uLLitu|_input")] Input,
    ...
    #[regex("தளம்_வினா|qaLam_viZA|_dbQuery")] DBQuery,
    ...
    #[regex("ஜேசான்|jEcAZ|_JSON")] JSONdb,
    
    // --- Database Operations ---
    #[regex("அட்டை|attY|_table")] Table,
    #[regex("தொகுப்பு|qokuppu|toguippu|_collection")] Collection,
    #[regex("நிரை|nirY|_row")] Row,
    #[regex("பத்தி|paqqi|_column")] Column,
    #[regex("விசை|vicY|_key")] Key,
    #[regex("தனிக_விசை|qaZika_vicY|taZik_vicY|_primaryKey")] PrimaryKey,
    ...
    #[regex("இதனில்|iqaZil|_from")] From,
    ...
    #[regex("தனிக|qaZika|_distinct")] Distinct,
    #[regex("வரம்பு|varampu|_limit")] Limit,
    #[regex("ஈடு|Itu|_offset")] Offset,

    // --- REST API & HTTP ---
    #[regex("தள_இடை|qaLa_itY|_api")] API,
    #[regex("இறுதி_புள்ளி|iRuqi_puLLi|iraqi_pulli|_endpoint")] Endpoint,
    #[regex("வழி|vazi|vazhi|_route")] Route,
    ...
    #[regex("பதில்|paqil|paDil|_response")] Response,
    #[regex("தலைப்பு|qalYppu|talYppu|_header")] Header,
    #[regex("உடல்|utal|uqal|_body")] Body,
    #[regex("அளவுரு|aLavuru|_param")] Param,
    #[regex("வினா_அளவுரு|viZA_aLavuru|_queryParam")] QueryParam,
    #[regex("பாதை_அளவுரு|pAqY_aLavuru|pAtY_aLavuru|_pathParam")] PathParam,
    #[regex("ஜேசான்_உரை|jEcAZ_urY|_jsonBody")] JSONBody,
    #[regex("உரலி|urali|_url")] URL,
    #[regex("புரவலன்|puravalaZ|_host")] Host,
    ...
    #[regex("தலை|qalY|talY|_head")] HttpHead,
    #[regex("நிலை_குறி|nilY_kuRi|_statusCode")] StatusCode,
    #[regex("நிலை_செய்தி|nilY_ceyqi|_statusMessage")] StatusMessage,
    ...
    #[regex("வழங்கி_தொடங்கு|vazawki_qotawku|vazawki_toqotawku|_startServer")] StartServer,
